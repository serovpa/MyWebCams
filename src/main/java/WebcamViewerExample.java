...
class WebcamViewerExample extends JFrame implements Runnable, WebcamListener, WindowListener, Thread.UncaughtExceptionHandler, ItemListener, WebcamDiscoveryListener {
    ...
    //public static void main(String[] args) throws IOException {
        ...
        public void run() {
            ...
            t.start();
            DetectMotionExample detectMotionExample = new DetectMotionExample();
        }
